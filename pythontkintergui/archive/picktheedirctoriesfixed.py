# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 19:26:34 2024
...
entries = {
    "Input": None,  # Corrected key names to match the loop below
    "Output": None,
    "Logs": None
}
...
for directory_name, label_text in [("Input", "Input Directory:"), ("Output", "Output Directory:"), ("Logs", "Logs Directory:")]:
    ...
    entry.pack()
    entries[directory_name] = entry  # Ensure the key matches the name used here
...
# Reset button
reset_button = tk.Button(window, text="Reset", command=reset_entries)
reset_button.pack()
